...
async def handle_tradingview_webhook(payload: TradingViewPayload):
    ...
    try:
        ...
        # Place TP order
        tp_order_type = {"trigger": {"triggerPx": str(tp_price_rounded), "isMarket": False, "tpsl": "tp"}}
        ...
        # Place SL order
        sl_order_type = {"trigger": {"triggerPx": str(sl_price_rounded), "isMarket": False, "tpsl": "sl"}}
